...
Справочник представляет собой API приложение для поиска номеров телефонов и информации об организациях. 
...
* Стандартное количество элементов на всех страницах(это список организаций, список элементов поиска, список сотрудников) — 10 штук, но пользователь может менять количество элементов.
